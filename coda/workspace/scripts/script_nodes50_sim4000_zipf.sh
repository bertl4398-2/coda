...
do
    ...
    PARAM="--numNodes=50 --simulationTime=4000 --phyMode=DsssRate1Mbps --verbose=0 --tracing=0 --width=500 --timeChange=2 --speed=Constant:13.89 --publicationsPerNode=$PUB_PER_NODE --requestsPerNode=$REQ_PER_NODE --startPublication=50 --startRequest=60 --contentLifetime=4000 --requestLifetime=30 --sizeBuffer=$BSIZE --interRequestPeriod=0 --helloPeriodicity=1000000 --helloMaxBackoff=3 --pitDelay=500000 --pitMaxBackoff=3 --powerLaw=$i"
