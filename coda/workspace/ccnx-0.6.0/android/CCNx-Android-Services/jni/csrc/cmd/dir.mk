...
INSTALLED_PROGRAMS = \
    combinestats ccn_ccnbtoxml ccn_splitccnb ccndumpnames ccnnamelist ccnrm \
...
CSRC =  combinestats.c ccn_ccnbtoxml.c ccn_splitccnb.c ccn_xmltoccnb.c ccnbasicconfig.c \
...
combinestats: combinestats.o
	$(CC) $(CFLAGS) -o $@ combinestats.o $(LDLIBS)
