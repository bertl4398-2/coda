...
CSRC = ccn_bloom.c \
       ...
       ccn_sockaddrutil.c ccn_setup_sockaddr_un.c llist.c ccn_statistics.c
LIBS = libccn.a
...
ccn_setup_sockaddr_un.o: ccn_setup_sockaddr_un.c ../include/ccn/ccnd.h \
  ../include/ccn/ccn_private.h
llist.o: llist.c ../include/ccn/llist.h
ccn_statistics.o: ccn_statistics.c ../include/ccn/ccn.h
